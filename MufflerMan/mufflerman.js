...
var hint_cards=[];
 ...
 var hint_card=function(x,y,hint){
     ...
     this.y=y;
     this.hint=hint;
     //this.addClick=addEventListener('click',function(e){
       //  alert('hey');
     //});
...
//adding click even to each hint card..
...
//console.log('hell');
//e.stopPropagation();
//canvas.removeEventListener('click',click_hint_card);

}

canvas.addEventListener('click',click_hint_card);
//canvas.onClick=click_hint_card();
